...
// interface.
//
// PENDÊNCIA (ver claude/migracao_vercel_supabase.md): os dois blobs base64 de imagem do
// original (--logo-black, que já estava com o placeholder "COLE_AQUI_O_VALOR_ORIGINAL" não
// preenchido no próprio Index original, e a imagem do emblema "CS Destaque" em
// .jornada-badge-img-wrap img) foram trocados por um pixel transparente 1x1 aqui, pra não
// arriscar corromper um base64 de milhares de caracteres numa transcrição manual. O valor
// original de --m-white (máscara do "M" líquido dos KPIs) foi preservado abaixo, ele é curto
// o bastante pra conferir com segurança. Os originais completos continuam intactos no doc
// "Index" do projeto MOAI — é só copiar de lá quando for ajustar o visual do logo/emblema.
...
<style>
:root {
  /* TODO (pendência): colar aqui o base64 do logo MOAI preto do topo — ver comentário no
     topo deste arquivo. Placeholder = pixel transparente 1x1. */
  ...
  /* M da MOAI usado como máscara do "M líquido" nos cards de KPI — mesmo valor do Index original. */
  --m-white: url(data:image/png;base64,);
}
    ...
    <div class="jornada-hero-inner">
      ...
      <div class="jornada-badge" id="pessoaBadgeDestaque">
        <div class="jornada-badge-img-wrap">
          <img src="data:image/png;base64,">
