...
.brand-logo { height: 20px; width: 90px; background-image: var(--logo-black); background-size: contain; background-repeat: no-repeat; background-position: left center; font-family:'Bricolage Grotesque',sans-serif; font-weight:800; font-size:16px; color:#1A1A1A; display:flex; align-items:center; }
.brand-logo::before { content: 'MOAI'; }
...
<div class="topbar">
  <div class="brand" onclick="showHome()"><div class="brand-logo"></div></div>
